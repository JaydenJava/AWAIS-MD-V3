...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "QCclQRbS#S4UdDUEQnLJD7buy3QUjDMumPCH31Zyi5Rzraf9TcK8",
    ...
    PACKNAME: (process.env.PACK_INFO?.split(';') || [])[1] || '256745944178',
    ...
    DEV: process.env.DEV || "256745944178", //replace with your whatsapp number
